...
def check_settings_changed(current_config_path: str = 'BehaveAI_settings.ini',
    ...
    Behaviour:
      - If no saved snapshot exists, return True (caller should treat as 'changed').
      - If saved snapshot exists and differs from current, return True.
      - If saved snapshot exists and is identical, return False.

    This function DOES NOT run the regeneration script; it merely reports whether
    a regeneration *would* be triggered.
    """
