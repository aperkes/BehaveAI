...
## Lightly edited version of train_classify to allow for training in the command line
...
def simple_retrain(model_type, yaml_path, project_path, model_path, classifier, epochs, imgsz):
...
if hierarchical_mode:
    ...
    if len(secondary_static_classes) >= 2:
        for primary_class in primary_classes:
            ...
            simple_retrain(model_dir, data_dir, model_dir, 
                weights_path, secondary_classifier, secondary_epochs, 224)
